...
//#ifdef SEPARATE_RE_IM
//static __inline void _fft_1d_r2(vector float *outReal, vector float *outImag, vector float *in, vector float *W, int log2_size)
//#else
...
#ifdef SEPARATE_RE_IM
  vector float *out0re, *out1re, *out2re, *out3re;
  vector float *out0im, *out1im, *out2im, *out3im;
#endif
...
# else
  ...
  do {
     ...
     */
    FFT_1D_BUTTERFLY   (out0re[0], out0im[0], out1re[0], out1im[0], 
       re_lo0, im_lo0, re_lo1, im_lo1, w0_re, w0_im);
    FFT_1D_BUTTERFLY   (out0re[1], out0im[1], out1re[1], out1im[1],  
       re_lo2, im_lo2, re_lo3, im_lo3, w1_re, w1_im);

    FFT_1D_BUTTERFLY_HI(out2re[0], out2im[0], out3re[0], out3im[0], 
       re_hi0, im_hi0, re_hi1, im_hi1, w0_re, w0_im);
    FFT_1D_BUTTERFLY_HI(out2re[1], out2im[1], out3re[1], out3im[1],  
